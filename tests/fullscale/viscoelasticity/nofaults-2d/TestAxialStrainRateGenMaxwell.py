...
class TestCase(FullTestCase):
    """Test suite for testing generalized Maxwell material with 2-D axial extension (Dirichlet velocity BC).
    """
...
class TestQuad(TestCase, meshes.Quad):
    NAME = "axialstrainrate_genmaxwell_quad"
...
class TestTri(TestCase, meshes.Tri):
    NAME = "axialstrainrate_genmaxwell_tri"
